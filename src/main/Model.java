...
public abstract class Model extends Thread {
    ...
    protected ArrayList<Agent> objects = new ArrayList<>();
    ...
    */
    ...
    /** Method to set viewabletype for all agents in model */
    public void setAgentsViewableType(String av) {
        for (Agent agent: agents) {
            agent.setViewableType(av);
        }
    }
